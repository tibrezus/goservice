...
dev-macports:
	...
	port installed kind || sudo port install kind
	port installed kubectl || sudo port install kubectl
	port installed kustomize || sudo port install kustomize
	port installed pgcli || sudo port install pgcli
	port installed watch || sudo port install watch
